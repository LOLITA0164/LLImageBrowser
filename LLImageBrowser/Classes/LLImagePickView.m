...
#import "LLImagePickView.h"
@interface LLImagePickView ()
<
    UITableViewDelegate,
...
@implementation LLImagePickView

+(void)showOnView:(UIView*)baseView Options:(NSArray<PhotoPickItem *> *)ops{
    if (ops.count==0) {
        return;
    }
    LLImagePickView* pickView = [[LLImagePickView alloc] initWithFrame:baseView.bounds];
