...
#import "LLImageTool.h"

@class LLImageBrowser;
@protocol LLImageBrowserDelegate <NSObject>
@optional
/**
 ...
 */
/// 主线程
-(UIView *)photoBrowser:(LLImageBrowser *)photoBrowser didScrollToPage:(NSInteger)currentPage;
/// 配合视图滚动使用
-(void)photoBrowser:(LLImageBrowser *)photoBrowser didScrollToPage:(NSInteger)currentPage completion:(void(^)(UIView *))completion;
/// 结束显示
-(void)photoBrowser:(LLImageBrowser *)photoBrowser didHidden:(NSInteger)currentPage;
/// 长按事件
-(void)photoBrowser:(LLImageBrowser *)photoBrowser longPress:(UILongPressGestureRecognizer*)longPress;
@end




@interface LLImageBrowser : UIView
@property (weak, nonatomic) id <LLImageBrowserDelegate> delegate;
