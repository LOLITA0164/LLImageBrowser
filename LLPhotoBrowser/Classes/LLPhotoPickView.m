...
#import "LLPhotoPickView.h"
@interface LLPhotoPickView ()
<
    UITableViewDelegate,
...
@implementation LLPhotoPickView

+(void)showOnView:(UIView*)baseView Options:(NSArray<PhotoPickItem *> *)ops{
    if (ops.count==0) {
        return;
    }
    LLPhotoPickView* pickView = [[LLPhotoPickView alloc] initWithFrame:baseView.bounds];
